...
export default function student() {
  ...
  const [profElectives, setProfElectives] = React.useState(
  ...
  React.useEffect(()=>{
    elective == "Professional electives"
      ? setAllCourses(profElectives)
      : setAllCourses(freeElectives);
  },[elective,profElectives,freeElectives])
  return (
    <div className="overflow-hidden">
      ...
      />
      <Wishlist
        credits={elective == "Professional electives" ? credits[0] : credits[1]}
        allCourses={allCourses}
        addorRemoveToWishList={addorRemoveToWishList}
      />
    </div>
